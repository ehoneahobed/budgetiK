    ...
    <div class="container">
        <div class="row col-md-12 mt-2">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Add Income Source to {{ $selected_budget->budget_name }}
            </h2>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header">Income Sources for current budget</div>
                    ...
                    <tbody>
                        ...
                        @foreach ($income_sources as $income_source)
                            <tr class="">
                                ...
                                <td>{{ $income_source->income_desc }}</td>
                                <td width='10%'>
                                    {{ $income_source->budgeted_amount }}
                                </td>
                                <td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   <h4> {{ $selected_budget->budget_name }}</h4>
                    <form action="{{ route('budget.income.save') }}" method="POST">
                        @csrf

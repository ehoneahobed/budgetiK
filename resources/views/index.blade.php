                ...
                <div class="row">
                    <div class="col-md-10">
                        <a class="navbar-brand" href="#">
                            <img src="{{ asset('backend/assets/img/budgetik logo.png') }}" alt="BudgetiK" width="20%" >
                        </a>
                    </div>
                        ...
                        <div class="col-md-2 float-right">
                                ...
                                <!-- if statement for links    -->
                                    @if (Route::has('login'))
                            @auth
                                <a class="btn btn-outline-light me-2" href="{{ url('/dashboard') }}" >Dashboard</a></li>
                            @else
                            <a href="{{ route('login') }}"  class="btn btn-outline-light me-2">Login</a>
                
                                @if (Route::has('register'))
                                    <a class="btn btn-warning" href="{{ route('register') }}">Sign up</a></li>
                                @endif
                                @endauth
            ...
            <div class="container col-xxl-8 px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                  <div class="col-10 col-sm-8 col-lg-6">
                    <img src="{{ asset('backend/assets/img/1.png') }}" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
                  </div>
                  <div class="col-lg-6">
